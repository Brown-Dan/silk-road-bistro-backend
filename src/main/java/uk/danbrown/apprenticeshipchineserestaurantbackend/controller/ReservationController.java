...
public class ReservationController {
    ...
    public ResponseEntity<Reservation> createReservation(Reservation reservation) throws FailureInsertingEntityException {
        return ResponseEntity.ok(reservationService.createReservation(reservation));
    }

    public ResponseEntity<Reservation> getReservationByUserId(String userId) {
